...
"messages" => array(
    ...
    'prompt_create_language_dir' => 'Do you want to create the language folder? [yes/no]',
    'prompt_push_content' => 'Push your content to Languara? [yes/no] ',
    'prompt_pull_content' => 'Do you want to pull your content from Languara? [yes/no] ',
    'prompt_continue_translating' => 'Do you want to continue? [yes/no] ',
    'prompt_register_before_continue' => 'Create a Languara account? [yes/no] ',
),
);
